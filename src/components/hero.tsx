        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <Reveal>
            ...
            <p className="text-slate-300 text-base md:text-xl mb-6 md:mb-8 max-w-xl">
              Прямые контракты с производителями. Индивидуальный подбор под
                ...
                <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 right-4 md:right-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 md:p-4 border border-white/20">
                    ...
                    <div className="flex flex-wrap gap-1.5 md:gap-2 text-xs">
                      <span className="bg-cyan-500 text-white px-3 py-1 rounded">
                        Москва
                      </span>
                      <span className="bg-cyan-500 text-white px-3 py-1 rounded">
                        Санкт-Петербург
                      ...
                      <span className="bg-slate-700 text-white px-3 py-1 rounded">
                        +83 региона
                      </span>
                    </div>
                  </div>
